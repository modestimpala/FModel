...
public class CUE4ParseViewModel : ViewModel
{
    ...
    public async Task ConvertToCpp(CancellationToken cancellationToken, GameFile entry)
    {
        try
        {
            ...
            {
                var errorMessage = result.Errors.Any() ? result.Errors.First() : "No Blueprint or Verse class found";
                FLogger.Append(ELog.Warning, () =>
